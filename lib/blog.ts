...
불안은 정보의 공백에서 자란다. 정보를 공백 없이 채우는 것이 위기관리의 핵심이다.
  ...
  {
    slug: 'blood-donor-dog-edge-story',
    title: '엣지가 나한테 편지를 보냈다',
    date: '2026-06-07',
    category: '에세이·칼럼',
    excerpt: '공혈견 엣지 기사를 1인칭 탐지견 시점으로 썼다. 독자들이 울었고, 편지가 왔고, 현금도 왔다. 기자 생활에서 기사가 세상을 바꾼다는 걸 처음 실감한 순간이었다.',
    readingTime: 6,
    relatedPortfolioSlugs: ['blood-donor-dog-edge'],
    content: `

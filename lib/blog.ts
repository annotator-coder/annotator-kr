...
편집인을 찾아가는 기자는 흔하지 않다.

기자의 기본 루틴은 정해져 있다. 취재원 관리, 취재, 기사. 그걸 반복한다. 굳이 기획서를 들고 편집인 방을 두드릴 이유가 없다.

나는 가끔 그랬다. 딱히 용감해서가 아니라, 하고 싶은 게 생기면 참기가 어려웠다. "이런 서비스 만들면 어떨까요" 하고. 거절당하면 또 다른 걸 들고 갔다. 어떤 건 됐고, 어떤 건 안 됐다.

팩플은 된 것 중 하나다. 혁신기업 뉴스레터를 만들어보자는 이야기를 꺼냈고, 같은 생각을 가진 사람들이 모였다. 창간 멤버로 처음부터 끝까지 설계에 참여했다. 뉴스레터 포맷, 홈페이지 기획, 콘텐츠 구조. 구독자 데이터를 보면서 어떤 콘텐츠가 오픈율을 올리는지 매주 리뷰했다. 구독자 2만 명, 오픈율 40%. 그게 됐다.

---

스토리폴은 조금 다른 경우다.

독자에게 일방적으로 기사를 내보내는 것에 한계를 느끼고 있었다. 독자가 뭘 궁금해하는지, 어느 지점에서 공감하는지를 알고 싶었다. 설문과 콘텐츠를 통합하면 가능할 것 같았다. 데이터를 보니 독자들이 반응할 만한 포인트가 보였다.

제안했고, 됐고, 실제로 운영했다. 독자들이 참여했다. 반응이 있으니까 계속하게 됐다. 나중엔 이런 포맷이 당연한 것처럼 됐다.

클럽하우스 방도 비슷하다. 음성 기반 SNS가 막 뜨기 시작하던 2021년 초였다. 모두가 어떻게 써야 할지 모르던 시절에, 창작자 이코노미를 주제로 방을 만들었다. 독자들이 들어왔다. 이야기를 나눴다. 텍스트가 아닌 목소리로 독자를 만나는 게 어떤 건지 처음 느꼈다.

레이싱 차트 영상도 마찬가지다. IT 기업들의 성장 히스토리를 정적인 그래프가 아니라 경쟁하듯 움직이는 영상으로 만들면 어떨까. 데이터 시각화를 영상으로 풀어낸 것이었는데, 반응이 좋았다.

---

물론 안 된 것도 있다.

3040을 위한 경제매체 bespoke. 알고리즘 편식을 막는 개인화 서비스 Know/edge. 기획서는 있었는데 현실이 되지 못했다. 초창기 퍼블리를 직접 찾아가서 '대선사용설명서'를 같이 만들자고 제안했던 것도, 결국 성사되진 않았다.

되지 않은 제안들을 실패라고 생각하지는 않는다. 그 생각들이 쌓여서 다음 제안이 됐다. bespoke 기획서를 쓰면서 버티컬 미디어가 뭔지 더 깊이 이해했고, 그게 팩플 기획에 영향을 줬다.

---

왜 그렇게 했는지 생각해보면, 결국 관찰자로 있는 게 답답했던 것 같다.

기자는 현장을 취재하고 글로 옮기는 사람이다. 의미 있는 일이다. 근데 스타트업을 취재하면서 계속 드는 생각이 있었다. "이거 내가 해도 되겠는데." 혁신적인 서비스를 발굴하고 기사로 쓰는 게 아니라, 그 안에서 직접 뭔가를 만들고 싶었다.

11년 동안 제안을 들고 다녔던 건, 취재 현장에서도 계속 플레이어이고 싶었기 때문인 것 같다.

결국은 그게 뉴스룸 밖으로 나오는 이유가 됐다.
    `.trim(),
  },
  {

...
언더라이너도 혼자 책 읽다가 아무한테도 안 보여주는 게 아쉬워서 만든 거였다. 비트코인 페이지도 같은 관심사 가진 사람들이 있을 것 같아서였다. 2018년에 데이터저널리즘 팀에서 독자 초청 모임을 연 것도 마찬가지다. 기사 내보내고 끝나는 게 싫었다. 독자 반응을 직접 듣고 싶었다.
